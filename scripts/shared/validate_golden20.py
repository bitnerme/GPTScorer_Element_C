...
def get_blended_model(element, mode):
    ...
    if element == "E":
        return "v1.2" if mode == "legacy" else "v1.7r"
    if element == "F":
        return "v1.2" if mode == "legacy" else "v1.62"
    if element == "G":
        return "v1.41" if mode == "legacy" else "v1.42"
    if element == "H":
        return "v1.0" if mode == "legacy" else "v2.0"
    if element == "I":
        return "v1.1" if mode == "legacy" else "v1.2"
    if element == "J":
        return "v1.0" if mode == "legacy" else "v1.5"
    if element == "K":
        return "v1.0" if mode == "legacy" else "v1.2"
    if element == "L":
        return "v1.5" if mode == "legacy" else "v1.6"
    return "v1.0"
